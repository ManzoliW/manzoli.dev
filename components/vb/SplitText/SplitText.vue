...
const runAnimation = () => {
  ...
  splitInstance = new GSAPSplitText(el, {
    ...
    onSplit(self) {
      ...
      // Apply initial frame synchronously so chars are hidden BEFORE the
      // root becomes visible — prevents a flash of fully-rendered text
      // between hydration and the first animation frame.
